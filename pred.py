...
st.header("Car Price Prediction Applications")

col1, col2 = st.columns(2)

with col1:
   f1=st.selectbox("Select the fuel type", ("Diesel","Petrol","CNG","LPG","Electric"))
...
with col1:
   t1=st.selectbox("Select the transmission", ("Automatic","Manual"))
